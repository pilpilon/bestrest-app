...
export function LandingPage({ onLogin }: LandingPageProps) {
    ...
    const faqs = [
        ...
        {
            q: 'מה קורה כשמגיע לגבול הסריקה החינמית היומית?',
            a: 'מוצגת הודעה ידידותית ואפשרות לשדרג. ניהול המתכונים, דשבורד, ועובדים נשארים פתוחים לחלוטין גם בחינם — רק המשך הסריקה מוגבל עד למחרת.',
        },
        {
